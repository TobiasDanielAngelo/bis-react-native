...
export class UserStore extends Model({
  ...
  fetchUser = _async(function* (this: UserStore, userId: string) {
    ...
    response = yield* _await(
      fetch(`${process.env["EXPO_PUBLIC_BASE_URL"]}/users/?userid=${userId}`, {
        method: "GET",
        headers: {
  ...
  loginUser = _async(function* (
    ...
    response = yield* _await(
      fetch(`${process.env["EXPO_PUBLIC_BASE_URL"]}/login`, {
        method: "POST",
  ...
  logoutUser = _async(function* (this: UserStore) {
    ...
    response = yield* _await(
      fetch(`${process.env["EXPO_PUBLIC_BASE_URL"]}/logout`, {
        method: "POST",
        headers: {
          "Content-type": "application/json",
          Authorization: `Token ${token}`,
  ...
  reauthUser = _async(function* (this: UserStore) {
    ...
    response = yield* _await(
      fetch(`${process.env["EXPO_PUBLIC_BASE_URL"]}/reauth`, {
        method: "POST",
        headers: {
          "Content-type": "application/json",
          Authorization: `Token ${token}`,
