...
import { CustomerQueueBar } from "../../components/sales/bars/CustomerQueueBar";
import { CustomerLaborItems } from "../../components/sales/groups/CustomerLaborItems";
import { CustomerSalesItems } from "../../components/sales/groups/CustomerSalesItems";
import { CustomerModal } from "../../components/sales/modal/Customer";
import { LaborItemModal } from "../../components/sales/modal/LaborItem";
import { PaymentRequestModal } from "../../components/sales/modal/PaymentRequest";
import { PaymentValidationModal } from "../../components/sales/modal/PaymentValidation";
import { SalesItemModal } from "../../components/sales/modal/SalesItem";
import { BackendProductSearch } from "../../components/sales/search/BackendProductSearch";
import { StatusPOSBar } from "../../components/sales/status/StatusPOSBar";
import {
  defaultCustomer,
  defaultLaborItem,
  defaultSalesItem,
...
export const POSView = memo(
  (props: { visible: boolean; setPOSInputFocus: (focus: boolean) => void }) => {
    ...
    return (
      props.visible && (
        <POSContext.Provider value={POSValues}>
          {loading ? (
            <LoadingView />
          ) : (
            <>
