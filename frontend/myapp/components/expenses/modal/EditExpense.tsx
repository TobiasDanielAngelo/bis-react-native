...
export const EditExpenseModal = (props: any) => {
  ...
  const { popup, setPopup, expense } = useContext(ExpenseReviewContext);
    ...
    <>
      ...
      >
        <View style={styles.msgBox}>
          ...
          >
            <Text style={{ fontSize: 20, color: "#888" }}>Receipt</Text>
            <TextInput
              style={{
                marginTop: -5,
                padding: 5,
          ...
          >
            <Text style={{ fontSize: 20, color: "#888" }}>Previous</Text>
            <Text
              style={{
                padding: 5,
                fontSize: 20,
          ...
          >
            <Text style={{ fontSize: 20, color: "#888" }}>Change</Text>
            <TextInput
              style={{
                marginTop: -5,
                padding: 5,
          ...
          >
            <Text style={{ fontSize: 20, color: "#888" }}>Updated Cost</Text>
            <Text
              style={{
                padding: 5,
                fontSize: 20,
