  ...
  return (
    <View
      style={[
        ...
        {
          backgroundColor:
            props.paymentStatus === "paid" && props.quantity > 0
              ? "white"
              : "gainsboro",
        },
      ]}
    >
      <View style={{ flex: 1 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <Text>{moment(new Date(props.dateTransacted)).format("h:mm A")}</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  subText: { fontSize: 15, fontFamily: "monospace", color: "grey" },
});
